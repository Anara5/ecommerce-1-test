...
function BasketPage() {
    ...
    const handleCheckout = async () => {
        ...
        const orderNumber = crypto.randomUUID?.() || Math.random().toString(36).substring(2, 9).toUpperCase();
        ...
        try {
            ...
            const checkoutUrl = await createCheckoutSession(groupedItems, metadata) as string;
        ...
        <div className="container mx-auto p-4 max-w-6xl">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            >
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-sm sm:text-base">
                                        Price: {" "}
                                        {((item.product.price ?? 0) * item.quantity).toFixed(2)} SEK
                                    </p>
                                </div>
                            </div>
                ...
                order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
                    <h3 className="text-xl fot-semibold">Order Summary</h3>
                    <div className="mt-4 space-y-2">
                        ...
                        <p className="flex justify-between text-2xl font-bold border-t pt-2">
                            <span>Total: </span>
                            <span>
                                {useBasketStore.getState().getTotalPrice().toFixed(2)} SEK
                            </span>
                        </p>
                    </div>
                    ...
                    {isSignedIn ? (
                        ...
                        <SignInButton mode="modal">
                            <span className="mt-4 w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                               Sign in to checkout 
                            </span>
